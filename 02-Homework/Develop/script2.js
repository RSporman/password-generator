...
var charCollectionEight = "abcdefghijklmnopqrstuvwxxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
...
function generatePassword(){
  ...
  if (chooseSpecialCharacters !== true && chooseLowercase !== true && chooseUppercase === true && chooseNumbers === true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionSix[Math.floor(Math.random() * charCollectionSix.length)];
  }

  if (chooseSpecialCharacters !== true && chooseLowercase === true && chooseUppercase !== true && chooseNumbers === true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionSeven[Math.floor(Math.random() * charCollectionSeven.length)];
  }

  if (chooseSpecialCharacters !== true && chooseLowercase === true && chooseUppercase === true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionEight[Math.floor(Math.random() * charCollectionEight.length)];
  }

  if (chooseSpecialCharacters === true && chooseLowercase !== true && chooseUppercase !== true && chooseNumbers === true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionNine[Math.floor(Math.random() * charCollectionNine.length)];
  }

  if (chooseSpecialCharacters === true && chooseLowercase !== true && chooseUppercase === true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionTen[Math.floor(Math.random() * charCollectionTen.length)];
  }

  if (chooseSpecialCharacters === true && chooseLowercase === true && chooseUppercase !== true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionEleven[Math.floor(Math.random() * charCollectionEleven.length)];
  }

  if (chooseSpecialCharacters !== true && chooseLowercase === true && chooseUppercase !== true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionTwelve[Math.floor(Math.random() * charCollectionTwelve.length)];
  }

  if (chooseSpecialCharacters !== true && chooseLowercase !== true && chooseUppercase === true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionThirteen[Math.floor(Math.random() * charCollectionThirteen.length)];
  }

  if (chooseSpecialCharacters === true && chooseLowercase !== true && chooseUppercase !== true && chooseNumbers !== true) {
    for (var i = 0; i < passwordLength; i++)
      password += charCollectionFourteen[Math.floor(Math.random() * charCollectionFourteen.length)];
  }
